...
import './PeekabooPixels.css';

function PeekabooPixels() {
  ...
  return (
    <div className="container">
      <h1 className="title">PeekabooPixels</h1>
      ...
      {(originalImage || segmentedImage) && (
        <div className="image-grid">
          ...
          <div className="image-box">
            <h3 className="image-title">Peekaboo Image</h3>
            <div className="image-wrapper">
              {segmentedImage && (
                <img
                  src={segmentedImage}
